...
def config_general():
    ...
    current_config = {
         ...
         "watermark": { "enabled": get_setting("watermark_enabled", defaults['watermark_enabled']), "text": get_setting("watermark_text", defaults['watermark_text']), "position": get_setting("watermark_position", defaults['watermark_position']) },
         "widgets": { "time": {"enabled": get_setting("widgets_time_enabled", defaults['widgets_time_enabled'])}, "weather": { "enabled": get_setting("widgets_weather_enabled", defaults['widgets_weather_enabled']), "location": get_setting("widgets_weather_location", defaults['widgets_weather_location']) }, "rss": { "enabled": get_setting("widgets_rss_enabled", defaults['widgets_rss_enabled']), "feed_url": get_setting("widgets_rss_feed_url", defaults['widgets_rss_feed_url']), "scroll_speed": get_setting("widgets_rss_scroll_speed", defaults['widgets_rss_scroll_speed']) } },
         "burn_in_prevention": { "enabled": get_setting("burn_in_prevention_enabled", defaults['burn_in_prevention_enabled']), "elements": get_setting("burn_in_prevention_elements", defaults['burn_in_prevention_elements']), "interval_seconds": get_setting("burn_in_prevention_interval_seconds", defaults['burn_in_prevention_interval_seconds']), "strength_pixels": get_setting("burn_in_prevention_strength_pixels", defaults['burn_in_prevention_strength_pixels']) },
    }
...
@check_password_changed
def config_media():
    """Displays and handles management of uploaded images and videos."""
